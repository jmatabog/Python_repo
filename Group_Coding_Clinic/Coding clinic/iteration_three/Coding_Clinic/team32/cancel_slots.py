...
def title_query(creds):
    ...
    Uses a while loop to get the user to input the title of the event 
...
def get_event_id(creds, event_title, start_date_time):
    ...
    called 'creds', string object 'event_title' and a list object 
    'start_date_time'. 
...
def delete_event(creds, username, event_title, start_date_time, event_id):
    """
...
eventId=event_id).execute()
    ...
    updated_event = service.events().delete(calendarId=\
'coding.clinic32@gmail.com', eventId=event['id']).execute()
...
def cancel_slot(creds, username):

    """
    Function called using a binary pickle object 'creds' and string object 
    'username'.

    This is the driver function in the module and intends to cancel slots 
    ...
    while event_title and start_date_time and event_id:
        ...
        if(event_title and start_date_time and event_id ):
            ...
            return delete_event(creds, username, event_title,\
