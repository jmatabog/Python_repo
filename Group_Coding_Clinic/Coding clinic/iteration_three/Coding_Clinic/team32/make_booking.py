...
def date_query(creds):
    ...
    start_date_time = input('Enter appointment date i.e: 2020-01-01 @ 14:00. \
').split()
...
<<<<<<< HEAD
    events_result = service.events().list(calendarId='coding.clinic32@gmail.com'\
                                        , timeMin=now, singleEvents=True,
                                        orderBy='startTime').execute()
=======
    # events_result = service.events().list(calendarId='coding.clinic32@gmail.com', timeMin=now,
...
>>>>>>> 63f50c2bfba465cd2b7ce44be99384b80705e2cb
    ...
    events_result = service.events().list(calendarId='coding.clinic32@gmail.com',timeMax=future,
                                        timeMin=now, singleEvents=True,
                                        orderBy='startTime').execute()
...
def update_event(creds, username, event_title, start_date_time, event_id):
    """
    Function called using binary pickle file 'creds', string object 
    'event_title',
    ...
    event = service.events().get(calendarId='coding.clinic32@gmail.com',\
eventId=event_id).execute()
    ...
    event_title = event['summary'] + ' with '+username
...
'coding.clinic32@gmail.com',sendNotifications=True,\
...
def make_booking(creds, username):
    """
    Function called using a binary pickle object 'creds' and string object 
    'username'.

    This is the driver function in the module and intends to make bookings 
    ...
    while event_title and start_date_time  and event_id:
        ...
        if(event_title and start_date_time and event_id ):
            ...
            return update_event(creds, username, event_title, start_date_time, event_id)
    
    # print('Could not make a booking. Please try again.')
