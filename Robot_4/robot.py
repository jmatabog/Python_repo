...
def call_command(command_name, command_arg, robot_name):
    if command_name == 'help':
        ...
        if track is False:
            return world.text.world.do_forward(robot_name, int(command_arg))
        else:
            return world.turtle.world.do_forward(robot_name, int(command_arg))
    elif command_name == 'back':
        if track is False:
            return world.text.world.do_back(robot_name, int(command_arg))
        else:
            return world.turtle.world.do_back(robot_name, int(command_arg))
    elif command_name == 'right':
        if track is False:
            return world.text.world.do_right_turn(robot_name)
        else:
            return world.turtle.world.do_right_turn(robot_name)
    elif command_name == 'left':
        if track is False:
            return world.text.world.do_left_turn(robot_name)
        else:
            return world.turtle.world.do_left_turn(robot_name)
    elif command_name == 'sprint':
        if track is False:
            return world.text.world.do_sprint(robot_name, int(command_arg))
        else:
            return world.turtle.world.do_sprint(robot_name, int(command_arg))
...
def handle_command(robot_name, command):
    ...
    if track is False:
        world.text.world.show_position(robot_name)
    else:
...
def robot_start():
    ...
    global position_x, position_y, current_direction_index, history, track 
    ...
    obs_list = world.text.world.obs_list
    world.text.world.show_obs()
    ...
    history.clear()
    world.obstacles.obs_list.clear()
